...
%%% by Sourav Deb, Kush Jain, Rijnard van Tonder, Claire Le Goues, and Alex Groce.
%%%
\setcopyright{acmlicensed}
\acmDOI{10.1145/3643756}
\acmYear{2024}
\copyrightyear{2024}
\acmSubmissionID{fse24main-p529-p}
\acmJournal{PACMSE}
\acmVolume{1}
\acmNumber{FSE}
\acmArticle{30}
...
\keywords{Software Testing, Mutants, Mutation Generation}
...
operators are used, with controls common to multiple languages.
Our approach is a good fit to modern
...
A portion of this work was funded by the National Science Foundation 
under NSF awards CCF-2129388, CCF-1910067, and CCF-2129446.  We also 
thank all contributors to the Universalmutator and Comby projects. 
