...
%This cost, we observe, falls especially on Comby in some
...
the inverting conditionals operation and some basic module mutations, a small subset of all the operators our tool implements. Furthermore, like existing mutation testing tools for source code,
